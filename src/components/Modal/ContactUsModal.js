...
function ContactUsModal() {
  ...
  return (
    <div>
      <div onClick={openModal} className="navigation-left-modal">
        CONTACT US
      </div>
      <Modal
        isOpen={modalIsOpen}
      ...
      >
        <div onClick={closeModal} className="Modal-btn">
          <i className="fa fa-times"></i>
        </div>
        <div className="ContactUs">
          <div className="ContactUs-left">
            <a
              href={data.allStaticMap.nodes[0].mapUrl}
              target="_blank"
            >
              <Img
                fixed={
